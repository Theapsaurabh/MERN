// Episode-04 Show me the code-> 28-03-2025
    ...
    return (
        <div className="header">
            <div className="logo-container">
                <img className="logo" src="https://marketplace.canva.com/EAGK_nqghyY/1/0/1600w/canva-green-and-yellow-illustrative-catering-food-logo-1eeM9ihgRqY.jpg"></img>
            </div>
        ...
        <div className="res-card" style={{
            backgroundColor: "#f0f0f0"
                ...
                <img className="item-1"
                 alt="food" src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/"+resData.data.cloudinaryImageId}></img>
    ...
    return  (
        <div className="body">
            ...
            <div className="res-container"> 
              {  /*  RestaruntCard */}
              {
                reslist.map(restaurant=><RestaruntCard key={restaurant.data.id} resData={restaurant}/>)
              }
